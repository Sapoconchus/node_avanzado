module.exports = {
    register: {
        ...
        body: `Thank you for registering on anunciaLOL. You will be provided with an API token on login. Username: ${this.username} Password: ${this.password}.`
    },
    createAd: {
        subject: `Your ad "${this.title}" has been created`,
        body: `Your ad has been properly created. Thank you for using our platform and good luck!`
    },
    updateAd: {
        subject: `Your ad "${this.title}" has been updated`,
        body: `Your ad has been properly updated. Thank you for using our platform and good luck!`
    },
    deleteAd: {
        subject: `Your ad "${this.title}" has been deleted`,
